...
protected:
  ...
  long FindConstructor(const std::string & buffer, const std::string & className, bool headerfile=true, long int startPos=0) const;
  ...
  void FindPublicArea(long int &before, long int &after, long int startPos=0) const;

  /** Find protected area in source code. */
  void FindProtectedArea(long int &before, long int &after, long int startPos=0) const;

  /** Find private area in source code. */
  void FindPrivateArea(long int &before, long int &after, long int startPos=0) const;
  ...
  std::string ExtractLine(long int pos);
